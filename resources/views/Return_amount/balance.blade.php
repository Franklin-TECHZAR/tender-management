...
@section('content')
            ...
            <div class="min-height-200px">
                <div class="page-header">
                    <div class="row">
                        <div class="col-6">
                            <div class="title">
                                <h4>Return Balance Management</h4>
                            </div>
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        Create Return Balance
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-md-6 d-flex justify-content-end align-items-center">
                            <button class="btn btn-primary add-btn" data-toggle="modal" data-target="#return-balance-modal">
    ...
    <div class="modal fade" id="return-balance-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        aria-hidden="true">
        ...
        $(document).ready(function() {
            $("#payment-form").validate({
                submitHandler: function(form) {
                    ...
                    console.log(data);
                    var url = "{{ url('return_balance/store') }}";
                    ...
                    $.ajax({
                        ...
                        success: function() {
                            $("#return-balance-modal").modal("hide");
                            table.clear().draw();
            ...
            $(document).on("click", ".edit-btn", function() {
                ...
                $("#edit_id").val(edit_id);
                $.ajax({
                    url: "{{ url('return_balance/fetch-edit') }}/" + edit_id,
                    dataType: "json",
                    success: function(response) {
                        ...
                        $("#return-balance-modal").modal("show");
            ...
            $(document).on("click", "#confirm-yes-btn", function() {
                ...
                $.ajax({
                    url: "{{ url('return_balance/delete') }}/" + edit_id,
                    method: "GET",
                    dataType: "json",
                    success: function(response) {
                        table.clear().draw();
