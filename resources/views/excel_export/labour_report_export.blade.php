...
<table>
    <thead>
        <tr>
            <th colspan="8" style="font-size: 15px;font-weight: 500;color: red;text-align: center;">
                {{ env('APP_NAME') }}</th>
        </tr>
        <tr>
            <th colspan="8" style="font-weight: 500;text-align: center;color:#0b027e;">
                Labour Report
            </th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <th style="width:200px;background: #0b027e;color:white;font-weight: 600;text-align: left">Labour</th>
            <th style="width:150px;background: #0b027e;color:white;font-weight: 600;text-align: left">Date</th>
