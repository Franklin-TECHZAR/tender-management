...
@section('content')
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="{{ url('purchase_dept') }}?show=New">Purchase Dept</a>
                                    </li>
                        ...
                        <div class="col-6 text-right">
                            <a href="{{ url('purchase_dept/payment-export') . '/' . $purchase_dept->id }}"
                                class="btn btn-success">
                                <i class="bi bi-file-earmark-excel"></i> Export
                            </a>
                            <button class="btn btn-primary add-btn" data-toggle="modal" data-target="#purchase_dept-modal">
    ...
    <div class="modal fade" id="purchase_dept-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="purchase_dept-form">
                    @csrf
                    <input type="hidden" name="purchase_dept_id" id="purchase_dept_id" value="{{ $purchase_dept->id }}">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="payment_for" id="payment_for" required>
                                ...
                                @foreach ($payment_for as $id => $name)
...
@section('addscript')
    <script>
        ...
        $(document).on("click", ".add-btn", function() {
            $("#purchase_dept-form")[0].reset();
        });
        $("#purchase_dept-form").validate({
            submitHandler: function(form) {
                $("#submit-btn").prop("disabled", true);
                var data = new FormData(form);
                var url = "{{ url('purchase_dept/payment-store') }}";
                $.ajax({
                    type: "POST",
                    url: url,
                    data: data,
                    ...
                    success: function(response) {
                        $("#purchase_dept-modal").modal("hide");
        ...
        $(document).on("click", "#confirm-yes-btn", function() {
            ...
            $.ajax({
                url: "{{ url('purchase_dept/remove-payment-log') }}/" + edit_id,
                method: "GET",
                dataType: "json",
                success: function(response) {
                    fetch_table();
        ...
        function fetch_table() {
            var purchase_dept_id = $("#purchase_dept_id").val();
            ...
            $.ajax({
                type: "GET",
                url: "{{ url('purchase_dept/fetch-payment-log') }}",
                data: {
