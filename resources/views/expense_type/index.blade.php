...
<script type="text/javascript">
    ...
    $("#expense-form").validate({
        submitHandler: function(form) {
            ...
            var url = "{{ url('expenses_type/store') }}";
            $.ajax({
                type: "POST",
                url: url,
                data: data,
        ...
        $("#edit_id").val(edit_id);
        $.ajax({
            url: "{{ url('expenses_type/fetch-edit') }}/" + edit_id,
            dataType: "json",
    ...
    $(document).on("click", ".add-btn", function() {
            ...
            $("#modal-title-label").html('Create Expense Type');
        });
    ...
    $(document).on("click", "#confirm-yes-btn", function() {
        ...
        $.ajax({
            url: "{{ url('expenses_type/delete') }}/" + edit_id,
            method: "GET",
            dataType: "json",
            success: function(response) {
                table.clear().draw();
