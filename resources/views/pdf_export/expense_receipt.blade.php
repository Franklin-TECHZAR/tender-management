                    ...
                    <div class="receipt-amount" style="padding: 1px 0px 4px;">
                        <table>
                            <tr>
                                ...
                                <td class="colon">:</td>
                                <td><span class="underline"><span><span style="font-family: DejaVu Sans; sans-serif; opacity: 0.9; font-size: 14px; margin-left: -5px;">&#8377;{{ number_format($expense->amount, 2) }}</span></span></td>
                            </tr>
                            <tr>
